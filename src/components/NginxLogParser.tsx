      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 dark:bg-dark-800 dark:border-dark-700">
            ...
            {/* Tab Navigation */}
            <div className="flex bg-gray-100 rounded-lg p-1 mb-6 dark:bg-dark-700">
              <button
                onClick={() => setActiveTab('upload')}
                className={`flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors ${
                  activeTab === 'upload'
                    ? 'bg-white text-blue-600 shadow-sm dark:bg-dark-600 dark:text-blue-400'
                    : 'text-gray-600 hover:text-gray-900 dark:text-dark-400 dark:hover:text-dark-300'
                }`}
              >
                {t('upload_file')}
              </button>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 dark:bg-blue-900/20 dark:border-blue-800">
            <h3 className="font-medium text-blue-900 mb-2 dark:text-blue-300">{t('supported_format')}</h3>
            <p className="text-sm text-blue-800 mb-2 dark:text-blue-200">
              {t('supported_format_desc')}
            </p>
            <ul className="text-xs text-blue-700 space-y-1 dark:text-blue-200">
